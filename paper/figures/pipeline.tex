...
\begin{tikzpicture}[
  ...
  \node[stage] (l5) at (0, -6.0) {L5: WordAbstract};
  \node[stage, fill=green!10] (proof) at (0, -7.2) {User proofs};
  ...
  \node[label, anchor=east] at (-2.0, -5.4) {BitVec $\to$ Int/Nat};
  ...
  \node[corres, anchor=west] at (2.0, -5.4) {\texttt{L5corres}};
\end{tikzpicture}
