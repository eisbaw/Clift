...
\addplot[blue!70!black, mark=*, mark options={fill=blue!50}] coordinates {
  ...
  (194, 8)  % pq_insert dynCom
  (208, 12) % pq_bubble_down WIP added
};
\addplot[red!60, dashed, domain=0:200] {0};
\node[font=\scriptsize, text=red!60!black] at (axis cs:180,4) {zero target};
\end{axis}
\end{tikzpicture}
\caption{Sorry elimination over 208 commits. The plateau at 17
reflects sorry blocked by kernel depth limits. The uptick at the end
is WIP proof scaffolding.}
