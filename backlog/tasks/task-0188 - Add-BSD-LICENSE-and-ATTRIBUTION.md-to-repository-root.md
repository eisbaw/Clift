...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 BSD LICENSE file at repo root for Clift
- [x] #2 ATTRIBUTION.md crediting AutoCorres2 authors (Greenaway, Lim, Klein, Hölzl, Immler, Schirmer, Sickert-Zehnter, Wimmer), Simpl (Schirmer), seL4 (Klein et al), and referencing ext/AutoCorres2/README.md for full details
- [x] #3 Note AutoCorres2 license terms (BSD code, CC-BY-SA-4.0 docs) in ATTRIBUTION.md
<!-- AC:END -->
